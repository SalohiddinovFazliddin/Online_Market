                ...
                <div class="w-full">
                    <div class="bb-register border-[1px] border-solid p-[30px] rounded-[20px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full px-[12px]">
                                <form method="post" class="flex flex-wrap mx-[-12px]">
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full px-[12px] mb-[24px]">
                                        ...
                                        <input type="text" name="firstname" placeholder="Enter your first name" class="w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]" required>
                                    </div>
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full px-[12px] mb-[24px]">
                                        <label class="inline-block mb-[6px] text-[14px] leading-[18px] font-medium text-[#3d4750]">Last Name*</label>
                                        <input type="text" name="Lasttname" placeholder="Enter your Last name" class="w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]" required>
                                    </div>
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full px-[12px] mb-[24px]">
                                    ...
                                    <div class="bb-register-wrap w-full px-[12px] mb-[24px]">
                                        ...
                                        <input type="text" name="phonenumber" placeholder="Address Line 1" class="w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]" required>
                                    </div>
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full px-[12px] mb-[24px]">
                                        <label class="inline-block mb-[6px] text-[14px] leading-[18px] font-medium text-[#3d4750]">City*</label>
                                        <div class="custom-select w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]">
                                            <select>
                                    ...
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full px-[12px] mb-[24px]">
                                        <label class="inline-block mb-[6px] text-[14px] leading-[18px] font-medium text-[#3d4750]">Post Code*</label>
                                        <input type="text" name="phonenumber" placeholder="Post Code" class="w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]" required>
                                    </div>
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full px-[12px] mb-[24px]">
                                        <label class="inline-block mb-[6px] text-[14px] leading-[18px] font-medium text-[#3d4750]">Country*</label>
                                        <div class="custom-select w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]">
                                            <select>
                                    ...
                                    <div class="bb-register-wrap w-[50%] max-[575px]:w-full] px-[12px] mb-[24px]">
                                        <label class="inline-block mb-[6px] text-[14px] leading-[18px] font-medium text-[#3d4750]">Region State*</label>
                                        <div class="custom-select w-full p-[10px] text-[14px] font-normal text-[#686e7d] border-[1px] border-solid border-[#eee] outline-[0] leading-[26px] rounded-[10px]">
                                            <select>
                                    ...
                                    <div class="bb-register-button w-full flex justify-center">
                                        <button type="button" class="bb-btn-2 transition-all duration-[0.3s] ease-in-out font-Poppins leading-[28px] tracking-[0.03rem] py-[4px] px-[20px] text-[14px] font-normal text-[#fff] bg-[#6c7fd8] rounded-[10px] border-[1px] border-solid border-[#6c7fd8] hover:bg-transparent hover:border-[#3d4750] hover:text-[#3d4750]">Register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
